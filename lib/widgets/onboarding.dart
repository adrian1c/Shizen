...
class OnboardingPage extends HookWidget {
  ...
  int changePage(next, pageController, selectedIndex) {
    ...
    pageController.animateToPage(selectedIndex,
        curve: Curves.linear, duration: Duration(milliseconds: 350));
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        minimum: const EdgeInsets.fromLTRB(0, 130, 0, 130),
        child: Column(
          children: [
            Expanded(
              child: PageView(
                ...
                children: selectedIndex.value == 1
                    ...
                    : selectedIndex.value == 0
                        ? [
                            ...
                            IconButton(
                                onPressed: () => selectedIndex.value =
                                    changePage(true, pageController,
                                        selectedIndex.value),
                                icon: Icon(
                                  Icons.keyboard_arrow_right_rounded,
                                  size: 30,
                        ...
                        : [
                            IconButton(
                                onPressed: () => selectedIndex.value =
                                    changePage(false, pageController,
                                        selectedIndex.value),
                                icon: Icon(
                                  Icons.keyboard_arrow_left_rounded,
                                  size: 30,
